...
<script>
function view(jid){
	window.location='Passengers.jsp?jid='+jid;
	...
	<div class="limiter">
		...
		<div class="container-table100">
			<div class="wrap-table100">
				<p style="text-align:right;font-size:28px;background-color:none">اختر احد الرحلات لعرض المسافرين على متنها</p>
...
-->		
		<div class="row" onclick="view(<%=resultSet.getString("j_id")%>);">
...
-->
<input type="hidden"  id="jid" value="${uid}" /> 
